...
def _split_markdown_sections(text: str) -> List[Tuple[str, Tuple[int, int], Dict[str, str]]]:
...
def split_with_metadata(
    ...
    sections = _split_markdown_sections(text) if markdown_aware else [(text, (0, len(text)), {"heading": "", "level": "0"})]
